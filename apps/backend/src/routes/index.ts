...
const LATEST_APP_VERSION = process.env.LATEST_APP_VERSION ?? '1.11.6';
const LATEST_APP_VC = parseInt(process.env.LATEST_APP_VC ?? '64', 10);
...
const LATEST_IOS_VERSION = process.env.LATEST_IOS_VERSION ?? '1.11.6';
const LATEST_IOS_BUILD = parseInt(process.env.LATEST_IOS_BUILD ?? '13', 10);
