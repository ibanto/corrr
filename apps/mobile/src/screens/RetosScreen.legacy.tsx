      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={styles.list} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.shopSection}>
              ...
              {earnOpen && (
                <View style={styles.earnContent}>
                  ...
                  <View style={styles.earnRow}>
                    ...
                    <Text style={styles.earnText}>10 pts por km recorrido</Text>
                  </View>
                  <View style={styles.earnRow}>
                    <Ionicons name="flag" size={16} color={colors.orange} />
                    <Text style={styles.earnText}>25-50 pts por cerrar un circuito</Text>
                  </View>
                  <View style={styles.earnRow}>
                    <Ionicons name="grid" size={16} color={colors.orange} />
                    <Text style={styles.earnText}>+1 pt por celda nueva, +2 por celda robada</Text>
                  </View>
                </View>
              )}
            </TouchableOpacity>
            ...
            {/* Comprar XP — pendiente de integrar Google Play Billing real.
                El mockup anterior (packs con precio que regalaban XP gratis) se
                quitó: vender bienes digitales sin Play Billing viola las
                políticas de Google. Se reactivará cuando esté el billing real. */}
            ...
            <View style={styles.comingSoonCard}>
              ...
              <Text style={styles.comingSoonHint}>
                Pronto podrás comprar packs de XP. De momento, ¡gánalo corriendo!
              </Text>
            </View>
          </View>
          )}
